...
void main()
{
  ...
  sum += TEX2D(xy + vec2(0.0, -4.0 * BLURFACTOR * oney)) * vec4(c4);
  sum += TEX2D(xy + vec2(0.0, -3.0 * BLURFACTOR * oney)) * vec4(c3);
  sum += TEX2D(xy + vec2(0.0, -2.0 * BLURFACTOR * oney)) * vec4(c2);
  sum += TEX2D(xy + vec2(0.0, -1.0 * BLURFACTOR * oney)) * vec4(c1);
  sum += TEX2D(xy);
  sum += TEX2D(xy + vec2(0.0, +1.0 * BLURFACTOR * oney)) * vec4(c1);
  sum += TEX2D(xy + vec2(0.0, +2.0 * BLURFACTOR * oney)) * vec4(c2);
  sum += TEX2D(xy + vec2(0.0, +3.0 * BLURFACTOR * oney)) * vec4(c3);
